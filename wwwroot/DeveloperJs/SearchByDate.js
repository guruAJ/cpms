$(document).ready(function () {
    ...
    $(':radio[value=1]').click(function () {
        ...
        window.location.replace("/Hrms/SearchByDate?Id=0&Project=HRMS");
    });
    $(':radio[value=2]').click(function () {
        // Might need to adjust the selector here based 
        // on the field you would like to hide

        window.location.replace("/Hrms/SearchByDate?Id=0&Project=IQMP");
...
$("#btnSearch").click(function () {
    ...
    $.ajax({
        type: 'POST',
        url: '/Hrms/SearchByDateToDateFrom',
        data: { "project": project, "DateTo": dateTo, "DateFrom": dateFrom, "unit": unit },
